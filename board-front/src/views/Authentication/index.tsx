...
export default function Authentication() {
            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        ...
                        <InputBox ref={emailRef} label='이메일 주소' type='text' placeholder='이메일을 입력해주세요.' value={email} onChange={onEmailChangeHandler} error={error} onKeyDown={onEmailKeyDownHandler} />
    ...
    const SignUpCard = () => {
        ...
        // state: 주소 요소 참조 상태 //
        const addresseRef = useRef<HTMLInputElement | null>(null);
        ...
        // state: Password Check 에러 메세지 상태 //
        ...
        // event handler: Password Check 버튼 클릭 이벤트 처리 //
        ...
        const onNextButtonClickHandler = () => {
            ...
            if (!isEmailPattern || !isValidPassword || !isEqualPassword) return;
        ...
        // event handler: Email 키 다운 이벤트 처리 //
        const onEmailKeyDownHandler = (event: KeyboardEvent<HTMLInputElement>) => {
            if (event.key !== 'Enter') return;
            if (!passwordRef.current) return;
            passwordRef.current?.focus();
            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        ...
                        {page === 1 && (
                            <>
                                <InputBox ref={emailRef} label='이메일 주소*' type='text' placeholder='이메일을 입력해주세요.' value={email} onChange={onEmailChangeHandler} error={isEmailError} message={emailErrorMessage} onKeyDown={onEmailKeyDownHandler} />
                    ...
                    <div className='auth-card-bottom'>
                        ...
                        {page === 2 && (
                            <>
                                <div className='auth-consent-box' onClick={onAgreedPersonalClickHandler}>
                                    <div className='auth-check-box'>
                                        <div className={`icon ${agreedPersonal ? 'check-round-fill-icon' : 'check-ring-light-icon'}`}></div>
                                    </div>
                                    <div className={isAddressError ? 'auth-consent-title-error' : 'auth-consent-title'}>{'개인정보동의'}</div>
                ...
                <div className='auth-jumbotron-box'>
                    <div className='auth-jumbotron-contents'>
                        ...
                        <div className='auth-jumbotron-text-box'>
                            ...
                            <div className='auth-jumbotron-text'>{'Board Test 입니다.'}</div>
                        </div>
                    </div>
                </div>
